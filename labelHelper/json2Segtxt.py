...
class ConvertManager(object):
    ...
    def __points_to_bbox(self, points):
        ...
        for file in tqdm(json_list):
            ...
            for shape in data_dict['shapes']:
                ...
                if shape['shape_type'] == 'rectangle':
                    ...
                    points2 = self.__rectangle_points_to_polygon(shape['points'])
                    # cx, cy, w, h = self.__points_to_bbox(points2)
                    # data_list.append(str(cx))
                    # data_list.append(str(cy))
            ...
            self.save_list(line_list, labels_dir + file[:-8] + "txt") # 多出了'.bmp'
